...
let XIVTextStyle = /*#__PURE__*/function (XIVTextStyle) {
  XIVTextStyle[XIVTextStyle["body"] = 0] = "body";
  XIVTextStyle[XIVTextStyle["headline"] = 1] = "headline";
  XIVTextStyle[XIVTextStyle["menu"] = 2] = "menu";
  return XIVTextStyle;
}({});
let XIVTextColor = /*#__PURE__*/function (XIVTextColor) {
  XIVTextColor[XIVTextColor["primary"] = 0] = "primary";
  XIVTextColor[XIVTextColor["accent"] = 1] = "accent";
  XIVTextColor[XIVTextColor["headline"] = 2] = "headline";
  return XIVTextColor;
}({});
function ColorStylesForTextColor(textColor) {
  switch (textColor) {
...
function XIVText({
  ...
  switch (textStyle) {
    case XIVTextStyle.body:
      return /*#__PURE__*/React$1.createElement("p", props([styles$9.text, textStyles.body, xstyle, textAlignStyles[textAlign], textColorStyle]), children);
    case XIVTextStyle.menu:
      return /*#__PURE__*/React$1.createElement("p", props([styles$9.text, textStyles.menu, xstyle, textAlignStyles[textAlign], textColorStyle]), children);
    case XIVTextStyle.headline:
      return /*#__PURE__*/React$1.createElement("h1", props([styles$9.text, textStyles.headline, xstyle, textAlignStyles[textAlign], textColorStyles.headline]), children);
    default:
      return /*#__PURE__*/React$1.createElement("p", props([styles$9.text, textStyles.body, xstyle, textAlignStyles[textAlign], textColorStyle]), children);
  }
}
...
function XIVButton({
  ...
  return /*#__PURE__*/React$1.createElement("button", _extends({}, props([styles$8.button, !disabled && styles$8.pressable, disabled && styles$8.disabled, xstyle]), {
    disabled: disabled,
    onClick: onClick
  }), /*#__PURE__*/React$1.createElement(XIVText, {
    textAlign: "center",
    textStyle: XIVTextStyle.body
  }, label));
}
const styles$8 = {
  button: {
    paddingBlock: "xj8oexa",
    paddingTop: null,
    paddingBottom: null,
    borderRadius: "x174e0gf",
  ...
  pressable: {
    filter: "xkcp37y xlcqwk8",
    transform: "x1c071of x1sjarlb",
    $$css: true
  },
  disabled: {
    filter: "xkcp37y x1uruofx",
    $$css: true
  }
};
...
function XIVUICard({
  ...
  return /*#__PURE__*/React$1.createElement("div", props(xstyle), /*#__PURE__*/React$1.createElement("div", {
    className: "xh8yej3 x5yr21d x1qsgzzv x1q4ynmn x1n2onr6 x3v996n x14odnwx x1jsoh5a x9f619 x16mibm7"
  }, /*#__PURE__*/React$1.createElement("div", {
    className: "xh8yej3 x12oqio5 x78zum5 x1n2onr6 xdt5ytf xb3r6kr x1cw2gcf x5yr21d x9f619 x6twhum"
  }, /*#__PURE__*/React$1.createElement("div", props([styles$7.content, contentXStyle]), children))));
}

// Card also has a background texture that we might need to rip from the game files
const styles$7 = {
  content: {
    marginInline: "xuqyx9n",
    marginInlineStart: null,
    marginLeft: null,
    marginInlineEnd: null,
    marginRight: null,
    marginBlock: "x15j7jsh",
    marginTop: null,
    marginBottom: null,
    $$css: true
  }
...
function XIVCircleButton () {
  return /*#__PURE__*/React$1.createElement("div", {
    className: "x78zum5 xl56j7k x6s0dn4"
  }, /*#__PURE__*/React$1.createElement("button", {
    className: "x1gs6z28 xw4jnvo x1qx5ct2 x1f96onm x13jnhi3 xaoc119"
  }));
}

// TODO
// 1. handle contextual layering (ensure hovers are always on top)
function useHoverable(hoverRef, renderedHoverRef) {
  const [isHovered, setIsHovered] = reactExports.useState(false);
  const [hoverPosition, setHoverPosition] = reactExports.useState({
    x: 0,
    y: 0
  });
  ...
  reactExports.useEffect(() => {
    if (isHovered) {
      const hoverPos = getHoverPosition(hoverRef, renderedHoverRef);
      if (hoverPos != null) {
  ...
  if (hoverPosition != null) {
    return [isHovered, styles$6.topAlign(hoverPosition.y, hoverPosition.x)];
  }
  return [isHovered, null];
}
function getHoverPosition(hoverRef, renderedHoverRef) {
  const hoverElement = hoverRef.current;
...
const styles$6 = {
  topAlign: (top, left) => [{
    top: top == null ? null : "x1g9fk1a",
    left: left == null ? null : "x837sfr",
    insetInlineStart: null,
    insetInlineEnd: null,
    $$css: true
  }, {
    "--top": (val => typeof val === "number" ? val + "px" : val != null ? val : undefined)(top),
    "--left": (val => typeof val === "number" ? val + "px" : val != null ? val : undefined)(left)
  }]
};

const XIVHoverRendererContext = /*#__PURE__*/reactExports.createContext({
  isHovered: false
});

function XIVHoverRenderer({
  children,
  hoverItem: HoverItem,
  hoverItemProps
}) {
  const hoverRef = reactExports.useRef(null);
  const renderedHoverRef = reactExports.useRef(null);
  const [isHovered, dynamicHoverStyles] = useHoverable(hoverRef, renderedHoverRef);
  const contextValue = reactExports.useMemo(() => {
    return {
      isHovered: isHovered
    };
  }, [isHovered]);
  return /*#__PURE__*/React.createElement(XIVHoverRendererContext.Provider, {
    value: contextValue
  }, /*#__PURE__*/React.createElement("div", {
    className: "x1n2onr6"
  }, isHovered && /*#__PURE__*/React.createElement("div", _extends({}, props([styles$5.defaultHover, dynamicHoverStyles]), {
    ref: renderedHoverRef
  }), /*#__PURE__*/React.createElement(HoverItem, hoverItemProps)), /*#__PURE__*/React.createElement("div", {
    ref: hoverRef
  }, children({
    isHovered,
    hoverRef
...
function XIVTooltipImpl({
  label
}) {
  reactExports.useContext(XIVHoverRendererContext);
  return /*#__PURE__*/React.createElement("div", {
    className: "x1sag07j xxgrknt x1q4ynmn x1awh872 x256u9z"
  }, /*#__PURE__*/React.createElement(XIVText, {
    textAlign: "center",
    textStyle: XIVTextStyle.body,
    xstyle: styles$4.tooltipText
  }, label));
}
const styles$4 = {
  tooltipText: {
...
function XIVTooltip({
  ...
  return /*#__PURE__*/React$1.createElement(XIVHoverRenderer, {
    hoverItemProps: {
      label
    },
...
let XIVAction = /*#__PURE__*/function (XIVAction) {
  XIVAction["ten"] = "nin/ten.png";
  XIVAction["chi"] = "nin/chi.png";
  XIVAction["jin"] = "nin/jin.png";
  XIVAction["rabbitMedium"] = "nin/rabbit_medium.png";
  return XIVAction;
}({});

function formatActionUrl(action) {
  return `/actions/${action}`;
}
function XIVActionIcon({
  action
}) {
  const url = reactExports.useMemo(() => formatActionUrl(action), [action]);
  console.log(url);
  return /*#__PURE__*/React.createElement("div", props(styles$3.action, styles$3.background(url)));
}
const styles$3 = {
  background: url => [{
    backgroundImage: `url(${url})` == null ? null : "x14gixet",
    objectFit: "xl1xv1r",
    backgroundPosition: "x1xsqp64",
    backgroundPositionX: null,
    backgroundPositionY: null,
    backgroundSize: "x25l62i",
    $$css: true
  }, {
    "--backgroundImage": `url(${url})` != null ? `url(${url})` : undefined
  }],
  action: {
    width: "x100vrsf",
    height: "x1vqgdyp",
...
function XIVActionButton({
  disabled,
  item,
  action
}) {
  const [isMouseDown, setIsMouseDown] = React$1.useState(false);
  ...
  return /*#__PURE__*/React$1.createElement("div", {
    ...
    className: "x1gs6z28 x11g6tue x100vrsf x1vqgdyp x9f619 x1n2onr6 x1sxf85j"
  }, /*#__PURE__*/React$1.createElement("div", props([styles$2.overlay, isMouseDown && styles$2.mouseDownGlow]), /*#__PURE__*/React$1.createElement(XIVActionIcon, {
    action: action
  })));
}
const styles$2 = {
  ...
  mouseDownGlow: {
    "::after_animationName": "xmcsnix",
    "::after_animationDuration": "xqynpor",
    "::after_content": "x1s928wv",
    "::after_position": "x1j6awrg",
    "::after_top": "x1t6k8l6",
    "::after_backgroundColor": "x1fsz3j",
    "::after_left": "x1qu55xf",
    "::after_insetInlineStart": null,
    "::after_insetInlineEnd": null,
    "::after_width": "xzkji8o",
    "::after_height": "x13r0tq7",
    "::after_borderRadius": "x1h9ftd2",
...
function XIVTitleText({
  children
}) {
  return /*#__PURE__*/React$1.createElement("h1", {
    className: "x1hgq9w7 x1pxj505 x1ulgg28 x1gzvz0a xno9vxg"
  }, children);
}
...
function XIVMenu({
  ...
  return /*#__PURE__*/React.createElement(XIVUICard, {
    xstyle: styles$1.container
  }, /*#__PURE__*/React.createElement("div", {
    className: "x78zum5 xdt5ytf x16zck5j x1jzhcrs"
  }, children));
}
const styles$1 = {
  container: {
...
function XIVPressable({
  ...
  return /*#__PURE__*/React.createElement("button", _extends({
    onClick: onPress
  }, props([styles.container, xstyle])), children);
}
const styles = {
  container: {
    border: "x1gs6z28",
...
function XIVMenuItem({
  label
}) {
  const onPress = reactExports.useCallback(e => {
    console.log("menu item pressed");
  }, []);
  return /*#__PURE__*/React.createElement(XIVPressable, {
    onPress: onPress
  }, /*#__PURE__*/React.createElement("div", {
    className: "xe2zdcy x1m3ak92 x7v69y5"
  }, /*#__PURE__*/React.createElement(XIVText, {
...
export { XIVAction, XIVActionButton, XIVButton, XIVUICard as XIVCard, XIVCircleButton, XIVMenu, XIVMenuItem, XIVText, XIVTextColor, XIVTextStyle, XIVTitleText, XIVTooltip };
